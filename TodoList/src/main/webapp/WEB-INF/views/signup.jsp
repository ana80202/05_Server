...
<body>
	<main>
		...
		<form action= "/signup" method="post" class="signup-form" onsubmit="return validate()">
			<p>아이디</p>
			<input type="text" name="inputId" id="inputId" autocomplete="off" required="required">
			 <!--autocomplete="off": 자동완성 끄기  -->
			 
			 <span id="idMsg">영어 소문자, 숫자, 특수문자 포함 6~ 14글자 </span>
			 
			 <p>비밀번호</p>
			 <input type="password" name="inputPw" id="inputPw" required="required">

			 <p>비밀번호 확인</p>
			 <input type="password" name="inputPw2" id="inputPw2" required="required">
