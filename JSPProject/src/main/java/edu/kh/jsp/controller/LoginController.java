...
@WebServlet("/login")  //현재 클래스를 servlet등록 + /login 요청을 처리
public class LoginController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//입력된 ID/PW user01/pass01 이면 "로그인 성공"
		...
		// servlet 으로 클라이언트에게 응답할 화면을 만들어야하는데
		// -> 작성하기 힘드니까 더 잘만들어주는 JSP 에게 위임
		...
		//message 값을 속성(Attribute)으로 추가하는것
		// -> Map 형식으로 작성 ( K : V)
