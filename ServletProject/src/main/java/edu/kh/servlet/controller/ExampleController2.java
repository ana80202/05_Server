...
public class ExampleController2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//-> tomcat10 버전 이상부터 자동으로 인코딩 처리흫 해주기 때문에 추가적인 처리 필요 X
		...
		//http://localhost:8080/signUp :노출되지 않음
		
		//응답화면 만들기
		//-> Java에서 작성하기 너무 귀찮고 힘들다
		//누가 이것 좀 대신 만들어주라
		//-> jsp가 대신 화면을 만들어 줘라! ( servlet이 jsp에게 요청을 위임함)
		...
		//Servlet이 어떤 요청을 받았는지 알아야 한다
		 ...
		 dispatcher.forward(req, resp); //forward : 요청이 왔을때 페이지에 위임하는거 **** 매우 중요***
